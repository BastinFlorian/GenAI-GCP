...
#HOST = "http://127.0.0.1:8181" #pour test local 

HOST = "https://elyesragapi-1021317796643.europe-west1.run.app"


st.title("Elyes's RAG Chatbot")
...
for n, message in enumerate(st.session_state.messages):
    ...
    st.chat_message(message["role"]).write(f"{icon} {message['content']}")
