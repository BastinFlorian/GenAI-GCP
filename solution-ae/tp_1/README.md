...
gcloud run deploy ae-streamlit --image=europe-west1-docker.pkg.dev/dauphine-437611/dauphine-ar/ae-streamlit:latest --platform=managed --region=europe-west1 --allow-unauthenticated
