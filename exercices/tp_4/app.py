...
HOST = "https://hibkab4-api-1021317796643.europe-west1.run.app"

# Constants for the backend API endpoint
#HOST = "https://hibk4-api-1021317796643.europe-west1.run.app/answer"
