...
HOST = "https://fz3-api-1021317796643.europe-west1.run.app" #IMPORTANT commentaire!! :laissez le host sur localhost par défaut pour les premières étapes, après avoir executé la partie de build et deploy api vous allez avoir une url renvoyée dans le terminal de vscode vous la mettez dans le host avant de déployer l'application streamlit avec les 2 dernières commandes
...
if "messages" not in st.session_state:
    st.session_state["messages"] = [
        {
            "role": "assistant",
            "content": "Hello ! I'm Noveller the short story teller ! Which theme would interest you?",
        }
    ]
