...
```bash
Invoke-RestMethod -Uri "http://localhost:8181/answer" -Method POST -Headers @{"accept"="application/json"; "Content-Type"="application/json"} -Body '{"name":"Youssef","genre":"Man","language":"English"}'
